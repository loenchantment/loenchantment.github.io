const url = 'https://loenchantment.github.io/bountiful-foods/data.json';
async function getFruitNames() {
    const response = await fetch(url);
    const data = await response.json();
    console.table(data.choices);
    displayFruits(data.choices);
  }
 ...
 const displayFruits = (choices) => {
         const fruits = document.getElementsByClassName('chooseFruit');
